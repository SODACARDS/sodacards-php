 ...
 */
class SodacardsDevpublicV1PlacedOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sodacards.devpublic.v1.PlacedOrder';
     ...
     * Sets id
     *
     * @param string|null $id id identifies the order; use it to poll the order and reveal its codes.
     *
     * @return self
     */
